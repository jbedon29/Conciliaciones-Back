...
namespace Protecta.Application.Service.Services.CobranzasModule
{
    public interface ICobranzasService
    {
        ...
        Task<ResponseControl> InsertarRecSelFormaPagoTemp(List<ConsultaInsertListaFPTempDto> ListaAgregadaFPTempDto);
        Task<IEnumerable<ReporteListaFPSelTempDto>> GetListaSelFPTemp(ConsultaListaFPSelTempDto consultaListaFPSelTempDto);


        Task<ResponseControl> ProcessGenerarPlanillaFP(PlanillaFPDto planillaFPDto);
