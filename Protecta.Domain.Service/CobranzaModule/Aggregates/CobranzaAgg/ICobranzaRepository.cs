...
namespace Protecta.Domain.Service.CobranzaModule.Aggregates.CobranzaAgg
{
    public interface ICobranzaRepository
    {
        ...
        Task<ResponseControl> InsertarRecSelFormaPagoTemp(List<ConsultaInsertListaFPTemp> listaAgregadaFPTemp);
        Task<List<ReporteListaFPSelTemp>> GetListaSelFPTemp(ConsultaListaFPSelTemp consultaListaFPSelTemp);
        Task<ResponseControl> ProcessGenerarPlanillaFP(PlanillaFP _request);
